...
public class ListDrawerAttribute : ReferenceFieldDrawerAttribute, IListElementIndexerAttribute
{
    ...
    public ListDrawerAttribute(string a_name) : base(a_name)
    {
        m_name = a_name;
    }
    ...
    {
        get { return typeof(ListFieldDrawer); }
    }

    public override Type FieldDataType => typeof(ListFieldData);
}
